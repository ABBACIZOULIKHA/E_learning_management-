            ...
            <div className="bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2">
              <div className="flex justify-between items-center mb-2">
                ...
                <Button
                  ...
                  className="border-none text-orange-600 group"
                >
                  <Plus className="mr-1 h-4 w-4 text-orange-600 group-hover:white-100" />
                  <span className="text-orange-600 group-hover:white-100">
                    Add Section
                  </span>
                </Button>
              </div>
